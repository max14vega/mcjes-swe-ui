...
import { Button, Grid2, Avatar, Card, CardContent, ThemeProvider, Container, Typography, Icon } from '@mui/material';
...
const people = [
  ...
  { id: 5, name: 'Eduardo de los Santos', icon: 'https://via.placeholder.com/50' },
...
function Person({ person }) {
  ...
  return (
	<ThemeProvider theme={theme}>
		<Card>
		<CardContent sx={{ display: "flex", alignItems: "center", marginBottom: -1 }}>
  ...
  return (
	<ThemeProvider theme={theme}>
		<Container maxWidth="lg" >
			<div>
				<Typography variant="h4" sx={{ marginBottom: 2, marginTop: 2}}>People</Typography>
			</div>
			<hr></hr>
			<div>
				...
				{addingPerson ? (
					...
					<Grid2 xs={12} sm={6} md={4} lg={3}>
						<Card sx={{ height: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', cursor: 'pointer' }}
